import numpy as np # used for matrix and vector operations.
import matplotlib.pyplot as plt #used to display images and plots.
import cv2 # OpenCV, used to read and convert the image.
